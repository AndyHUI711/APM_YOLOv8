...
def run(
    ...
    if True:
        if region_type == 'both':
            entrance = [0, region_line1, 640, region_line1, 0, region_line2, 640,
                        region_line2]

        elif region_type == 'right':
            entrance = [0, region_line2, 640, region_line2]

        elif region_type == 'left':
            entrance = [0, region_line1, 640, region_line1]
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default=WEIGHTS / 'YOLOv8_best.engine', help='model.pt path(s)')
    ...
    parser.add_argument('--source', type=str, default='/home/cyhuiae/PycharmProjects/fyp_yolov8/test_videos/1.mp4',
